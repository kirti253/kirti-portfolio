              ...
              <div className="flex-1 pb-8 md:pb-10">
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4">
                      ...
                      <h2 className="text-base sm:text-lg md:text-xl font-bold text-foreground break-words">
                        ...
                        {experience.companyUrl ? (
                          <Link
                            ...
                            className="hover:text-foreground/80 transition-colors underline break-words"
                          >
                            {experience.company}
                          </Link>
                        ) : (
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-foreground/60 font-medium whitespace-nowrap shrink-0">
                      {experience.dates}
                    </p>
                  </div>
